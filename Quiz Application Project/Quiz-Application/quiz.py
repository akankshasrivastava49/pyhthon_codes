...
def quizQuestions():
	if len(user) == 0:
		...
		if user[1] == "SUPERUSER":
			...
			print("You don't have access to adding questions. Only SUPERUSER are allowed to add questions.")
...
def about():
	print('''\n==========ABOUT US==========
This project has been created by Akanksa Srivastava . It is a basic Python Project for Python Assesment.''')

if __name__ == "__main__":
	choice = 1
	while choice != 7:
		print('\n=========WELCOME TO EDYODA QUIZ MASTER==========')
		print('-----------------------------------------')
		print('1. PLAY QUIZ')
